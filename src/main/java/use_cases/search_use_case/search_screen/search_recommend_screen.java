...
import use_cases.RecommendUseCase.RecommendController;
import use_cases.search_use_case.SearchController;
import use_cases.search_use_case.SearchResponseModel;
import use_cases.search_use_case.RecommendResponseModel;
...
public class search_recommend_screen extends JFrame {
    ...
    public search_recommend_screen(SearchController searchController, UserActController likeController,
        ...
        search_recommend_screen frame = new search_recommend_screen(searchController, likeController, recommendController);
    ...
    private void GenerateSearchResult() {
        ...
        try {
            ...
            SearchResponseModel responseModel = searchController.search(searchTexts, userName);
