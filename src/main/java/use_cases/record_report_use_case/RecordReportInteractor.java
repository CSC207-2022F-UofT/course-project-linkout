...
public class RecordReportInteractor implements RecordReportInputBoundary {
    ...
    UserGateway recordReportGateway;
    boolean success;
    String adminID;
     ...
     */
    public RecordReportInteractor(RecordReportOutputBoundary recordReportOB, UserGateway recordReportGateway, ReportDatabaseGateway recordReportDB, String adminID) {
