 ...
 */
public class ButtonColumnProfile extends AbstractCellEditor
...
//    public ButtonColumn(JTable table, Action action, int column)
    public ButtonColumnProfile(JTable table,Action action, int column){
        this.table = table;
        this.action = action;

        renderButton = new JButton("Profile");
    ...
    {
        editButton.setText("Profile Showed");
